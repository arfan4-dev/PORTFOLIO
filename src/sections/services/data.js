...
const data = [
    ...
    {
        id: 4, icon: <AiFillAppstore />, title: 'Web Development', desc: 'Unlike other developers in the market, I will building an app that runs on both IOS and Android devices without any extra cost to you.'
    }
]
